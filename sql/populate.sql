...
INSERT INTO tvshow(info, show_name, director_name, writer_name) VALUES('The world of the Vikings is brought to life through the journey of Ragnar Lothbrok', 'Vikings', 'Michael Hirst', 'Bill Prady');

INSERT INTO tvshow(info, show_name, director_name, writer_name) VALUES ('Mr. Robot follows Elliot Alderson, a young computer programmer with an anxiety order, who is recruited by Mr Robot and his anarchist team of hackers fscoiety', 'Mr.Robot', 'Niels Arden Oplev', 'Sam Esmail');

INSERT INTO tvshow(info, show_name, director_name, writer_name) VALUES ('A high school chemistry teacher diagnosed with inoperable lung cancer turns to manufacturing and selling methamphetamine in order to secure his familys future.', 'BreakingBad', 'Vince Gilligan', ' Vince Gilligan');

INSERT INTO tvshow(info, show_name, director_name, writer_name) VALUES ('Nine noble families fight for control over the mythical lands of Westeros, while a forgotten race returns after being dormant for thousands of years.', 'GameOfThrones', 'D.B. Weiss', ' George RR Martin');
...
INSERT INTO season(season_no, info, season_year, show_name) VALUES(1, 'Diagnosed with terminal lung cancer, chemistry teacher Walter White teams up with his former student, Jesse Pinkman, to cook and sell crystal meth.', 2008, 'GameOfThrones');
